    ...
    public void build() throws IOException {
        ...
        for (ExecutableElement mapperMethod : mapperMethods) {
            ...
            if (firstMethod) {
                ...
                String adapterName = new StringBuilder(type.toString()).append(XMapperConstants.MAPPER_CLASS_SUFFIX).toString();
