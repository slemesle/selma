...
import fr.xebia.extras.it.mappers.BadCustomMapper;
import fr.xebia.extras.it.mappers.EmptyCustomMapper;
import fr.xebia.extras.it.mappers.FailingCustomMapper;
...
public class FailingCustomMapperIT extends IntegrationTestBase {
    ...
    public void should_raise_compilation_error_when_no_valid_mapping_method_found() throws Exception {
        ...
        assertCompilationError(EmptyCustomMapper.class, "public class EmptyCustomMapper {", "No valid mapping method found in custom mapper class ");
    ...
    public void should_raise_warning_for_not_public_static_valid_method() throws Exception {
        ...
        assertCompilationError(BadCustomMapper.class, "public class BadCustomMapper {", "No valid mapping method found in custom mapper class ");
